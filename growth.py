...
def stats(path):
    ...
    num_infographics = {"2014": 0, "2015": 0,
    ...
    for year in years:
        ...
        print("The total number of infographics in " +
              year + " is: " + str(num_infographics[year]))
        print("The percentage of images in " + year + " that were infographics is: " +
              str(100 * num_infographics[year]/num_images[year]))
